...
/**
 *  aprendoz_test.VPorcentajeCalificacionId
 *  11/07/2014 13:24:50
 * 
 */
public class VPorcentajeCalificacionId
    implements Serializable
{
    ...
    private Integer esperadosFecha;
    private String nameExp16;
    private String porcentaje;

    public VPorcentajeCalificacionId() {
    }

    public VPorcentajeCalificacionId(String schoolYear, Integer idNivel, String nivel, Integer idGrado, String grado, Integer idCurso, String curso, Integer idPersona, String apellido1, String apellido2, String nombre1, String nombre2, Integer idAsignatura, String asignatura, Integer esperadosFecha, String nameExp16, String porcentaje) {
        ...
        this.esperadosFecha = esperadosFecha;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VPorcentajeCalificacionId)) {
            return false;
        }
        VPorcentajeCalificacionId other = ((VPorcentajeCalificacionId) o);
        ...
        if (this.esperadosFecha == null) {
            if (other.esperadosFecha!= null) {
                return false;
            }
        } else {
            if (!this.esperadosFecha.equals(other.esperadosFecha)) {
                return false;
            }
        }
    ...
    public int hashCode() {
        ...
        rtn = (rtn* 37);
        if (this.esperadosFecha!= null) {
            rtn = (rtn + this.esperadosFecha.hashCode());
        }
        rtn = (rtn* 37);
        if (this.nameExp16 != null) {
    ...
    public Integer getEsperadosFecha() {
        return esperadosFecha;
    }

    public void setEsperadosFecha(Integer esperadosFecha) {
        this.esperadosFecha = esperadosFecha;
    }

    public String getNameExp16() {
        return nameExp16;
    }

    public void setNameExp16(String nameExp16) {
        this.nameExp16 = nameExp16;
    }
