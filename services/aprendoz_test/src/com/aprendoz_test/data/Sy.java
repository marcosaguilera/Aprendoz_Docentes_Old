...
public class Sy {
    ...
    public Sy(Integer idSy, String schoolYear, Date fechaDesde, Date fechaHasta, Set<com.aprendoz_test.data.Promocion> promocions, Set<com.aprendoz_test.data.InscAlumCosto> inscAlumCostos, Set<com.aprendoz_test.data.InscCoordinadoresCurso> inscCoordinadoresCursos, Set<com.aprendoz_test.data.CoordinacionDeGrupo> coordinacionDeGrupos, Set<com.aprendoz_test.data.InscAlumCurso> inscAlumCursos, Set<com.aprendoz_test.data.BimestreSy> bimestreSies, Set<com.aprendoz_test.data.Cronograma> cronogramas, Set<com.aprendoz_test.data.Semana> semanas, Set<com.aprendoz_test.data.InscComentariosAlumnos> inscComentariosAlumnoses, Set<com.aprendoz_test.data.Horario> horarios, Set<com.aprendoz_test.data.Periodo> periodos, Set<com.aprendoz_test.data.Asignatura> asignaturas, Set<com.aprendoz_test.data.Educom> educoms, Set<com.aprendoz_test.data.Coordinadores> coordinadoreses, Set<com.aprendoz_test.data.Costos> costoses, Set<com.aprendoz_test.data.Matricula> matriculas, Set<com.aprendoz_test.data.SesionNivel> sesionNivels, Set<com.aprendoz_test.data.SecretariaEquivalenciaNotas> secretariaEquivalenciaNotases, Set<com.aprendoz_test.data.Coordinacion> coordinacions) {
        this.idSy = idSy;
        this.schoolYear = schoolYear;
        this.fechaDesde = fechaDesde;
        this.fechaHasta = fechaHasta;
