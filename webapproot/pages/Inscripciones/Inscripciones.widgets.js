	...
	layoutBox1: ["wm.Layout", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top"}, {}, {
		panel2: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
			panel1: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				...
				label2: ["wm.Label", {"height":"115px","width":"100%","border":"0","caption":"A continuación seleccione la <u>Asignatura</u> a la cual desea (+Agregar) o (-Retirar) alumnos.<br><br>Una vez hecho esto, el listado aparecera en <u>Estudiantes por Curso</u> podrá seleccionarlos y (+Agregar) a la asignatura.","singleLine":false}, {}, {
					format: ["wm.DataFormatter", {}, {}]
				}],
			...
			panel4: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				...
				label3: ["wm.Label", {"height":"115px","width":"100%","border":"0","caption":"Para (+Agregar) alumnos a un listado de Asignatura deberá realizar el siguiente proceso:<br><br>1). Haga clic sobre el/los alumnos que quiera agregar. Nota*** La tabla permite <b><u>multiselección.</u></b><br>2). Haga clic en el botón <u>+Agregar</u>.<br>*Importante: Espere unos segundos luego de <u>+Agregar</u> los alumnos.","singleLine":false}, {}, {
					format: ["wm.DataFormatter", {}, {}]
				}],
			...
			panel3: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				...
				label4: ["wm.Label", {"height":"115px","width":"100%","border":"0","caption":"Para retirar un alumno de la asignatura siga el siguiente proceso:<br><br>1). Seleccione un alumno de la lista.<br>2). Haga clic en el botón <u>-Retirar</u>","singleLine":false}, {}, {
					format: ["wm.DataFormatter", {}, {}]
				}],
				messageTop: ["wm.Label", {"height":"32px","width":"100%","border":"0","caption":"Seleccione una Asignatura","singleLine":false}, {}, {
					format: ["wm.DataFormatter", {}, {}]
				}],
				estudiantesInscritosAsignatura: ["wm.DojoGrid", {"height":"100%","border":"0","structure":"[[{\"field\":\"idpersona\",\"name\":\" \",\"width\":\"auto\",\"displayType\":undefined},{\"field\":\"apellidos\",\"name\":\"Apellidos\",\"width\":\"auto\",\"displayType\":undefined},{\"field\":\"nombres\",\"name\":\"Nombres\",\"width\":\"auto\",\"displayType\":undefined},{\"field\":\"curso\",\"name\":\"Curso\",\"width\":\"auto\",\"displayType\":undefined}]]","customFields":"[]","customFieldCounter":1}, {"onCellClick":"estudiantesInscritosAsignaturaCellClick"}, {
					binding: ["wm.Binding", {}, {}, {
