Reg_eventualidades.widgets = {
	...
	orientacionDocentesCorreo: ["wm.ServiceVariable", {"service":"aprendoz_test","operation":"sendMailHQL"}, {"onSuccess":"orientacionDocentesCorreoSuccess","onBeforeUpdate":"orientacionDocentesCorreoBeforeUpdate"}, {
		input: ["wm.ServiceInput", {"type":"sendMailHQLInputs"}, {}]
	}],
			...
			layer5: ["wm.Layer", {"caption":"layer5","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				panel1: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"center","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
					eventualidadesLiveForm1: ["wm.LiveForm", {"_classes":{"domNode":["wm_BackgroundColor_White","wm_Border_TopStyleCurved8px"]},"height":"100%","verticalAlign":"top","horizontalAlign":"left","readonly":true,"validateBeforeSave":true,"autoScroll":true}, {"onSuccess":"eventualidadesLiveVariable1","onBeginInsert":"eventualidadesLiveForm1BeginInsert","onInsertData":"eventualidadesLiveForm1InsertData","onDeleteData":"eventualidadesLiveForm1DeleteData"}, {
						...
						panel3: ["wm.Panel", {"height":"39px","width":"100%","horizontalAlign":"left","verticalAlign":"middle","layoutKind":"left-to-right"}, {}, {
							...
							quitar_butt2: ["wm.Button", {"height":"39px","width":"160px","caption":"Editar acta","disabled":true,"borderColor":"#aaa","iconUrl":"resources/images/buttons/update0.png","iconWidth":"20px","iconHeight":"20px","iconMargin":"0 0px 0 0"}, {"onclick":"quitar_butt2Click"}, {
								binding: ["wm.Binding", {}, {}, {
									wire: ["wm.Wire", {"targetProperty":"disabled","source":"editPanel1.formUneditable"}, {}]
								}]
							}]
						}],
						descripcion: ["wm.TextAreaEditor", {"height":"90px","width":"100%","caption":"Descripción","singleLine":false,"readonly":true,"formField":"descripcion"}, {}, {
							editor: ["wm._TextAreaEditor", {}, {}]
						}],
						autoevaluacion: ["wm.TextAreaEditor", {"height":"90px","width":"100%","caption":"Autoevaluación","singleLine":false,"readonly":true,"formField":"pregunta1"}, {}, {
							editor: ["wm._TextAreaEditor", {}, {}]
						}],
						pregunta2: ["wm.TextAreaEditor", {"height":"90px","width":"130%","caption":"Plan de acción para<br> resolver problemas o mejorar,<br> incluyendo formas de seguimiento","singleLine":false,"readonly":true,"formField":"pregunta2"}, {}, {
							editor: ["wm._TextAreaEditor", {}, {}]
						}],
						pregunta3: ["wm.TextAreaEditor", {"height":"90px","width":"100%","caption":"Socialización del plan con padres y otros, <br>y sus comentarios","singleLine":false,"readonly":true,"formField":"pregunta3"}, {}, {
							editor: ["wm._TextAreaEditor", {}, {}]
						}],
				...
				detalles_usuarios1: ["wm.Panel", {"height":"100%","width":"100%","horizontalAlign":"left","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
					layers7: ["wm.Layers", {}, {}, {
						layer7: ["wm.Layer", {"caption":"layer1","horizontalAlign":"left","verticalAlign":"top"}, {}, {
							...
							eventualidades: ["wm.DataGrid", {"_classes":{"domNode":["wm_FontSizePx_12px"]},"border":"0"}, {"onSelected":"eventualidadesSelected"}, {
								binding: ["wm.Binding", {}, {}, {
									wire: ["wm.Wire", {"targetProperty":"dataSet","source":"a_searchEventualities","expression":undefined}, {}]
								}],
								complex1: ["wm.DataGridColumn", {"caption":"Nombre completo","field":"complex","columnWidth":"150px","index":3}, {}, {
									format: ["wm.DataFormatter", {}, {}]
								}],
